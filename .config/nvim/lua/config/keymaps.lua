...
vim.keymap.set("n", "\\vs", "<CMD>vsplit<CR>", { silent = true, desc = "Vertical split" })
vim.keymap.set("n", "\\vn", "<CMD>vnew<CR>", { silent = true, desc = "Vertical new" })
vim.keymap.set("n", "\\vt", "<CMD>vsplit | terminal<CR>i", { silent = true, desc = "Vertical terminal" })
